                ...
                <div className="sidebarWrapper" >
                    ...
                    {/* =============================== Sidebar Links ================================ */}
                        <ul className="sidebarList">
                            <NavLink to="/home"  className="sidebarListItem active ">
                                Home 
                            </NavLink>
                            {/* -------------- start Users--------------------- */}
                            <li className="itemcontainsubmenue">
                                <span className="homeIconUser" ><i className="fa-solid fa-users"></i></span>
                                Users 
                                {/* ----Submenu Users---- */}
                                <ul className="SubmenuUsers">
                                    ...
                                    <fieldset className="fieldset">
                                        ...
                                        <legend className="legend1">
                                           Doctor</legend>
                                        <NavLink to="/pendingDoctors" className="sidebarListItemsubMenue">
                                        <i className="fa-solid fa-wheelchair p-1 me-1'"></i>
                                            <span>Pending Doctors</span>  
                                        </NavLink>
                                        <NavLink to="/confirmedDoctors" className="sidebarListItemsubMenue">
                                        <i className="fa-solid fa-user-check p-1 me-1'"></i>
                                             <span>Confirmed Doctors</span>
                                        </NavLink>
                                        <NavLink to="/blockedDoctors" className="sidebarListItemsubMenue">
                                    ...
                                    <div className="lineSubmenue2"></div>
                                        ...
                                        <NavLink to="/pendingMerchants" className="sidebarListItemsubMenue">
                                        <i className="fa-solid fa-wheelchair p-1 me-1'"></i>
                                            <span> Pending pharmacist</span>
                                        </NavLink>
                                        <NavLink to="/confirmedMerchants" className="sidebarListItemsubMenue">
                                        <i className="fa-solid fa-user-check p-1 me-1'"></i>
                                             <span>Confirmed pharmacist</span>
                                        </NavLink>
                                        <NavLink to="/blockedMerchants" className="sidebarListItemsubMenue">
                                        <i className="fa-solid fa-user-large-slash p-1 me-1"></i>
                            ...
                            <li className="itemcontainsubmenueEmployee">
                                ...
                                <ul className="SubmenuUsersEmployee">
                                    ...
                                    <fieldset className="fieldsetEmployee">
                                        ...
                                        <legend className="legend1">
                                            <i className="fa-solid fa-user-doctor-hair"></i> Flay Boy</legend>
