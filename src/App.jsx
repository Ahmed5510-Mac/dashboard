      ...
      <div className="layaout">
        ...
        <div className="container">
          ...
          <Routes>
            ...
            <Route path='/confirmedDoctors' element={<ConfirmedDoctors />} />
            <Route path='/blockedDoctors' element={<BlacklistDoctors />} />
            {/* Merchant Routes */}
            <Route path='/pendingMerchants' element={<PendingMerchants />} />
            <Route path='/confirmedMerchants' element={<ConfirmedMerchants />} />
            <Route path='/blockedMerchants' element={<BlacklistMerchants />} />
