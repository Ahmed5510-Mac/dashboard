...
export const getPendingMerchant = createAsyncThunk(
    ...
    async (_,thunkAPI) => {
        ...
        try {
            const res = await axios.get(baseAPI + "/dashboard/merchant/getpending/1");
            return res.data;
        } catch (error) {
...
export const getConfirmedMerchant = createAsyncThunk(
    ...
    async (pageNumber, thunkAPI) => {
        ...
        const { rejectWithValue } = thunkAPI;
        try {
            const res = await axios.get(baseAPI +`/dashboard/merchant/${pageNumber}`);
            return res.data;
        } catch (error) {
            return rejectWithValue(error.message);
        }
...
export const getBlockedMerchant = createAsyncThunk(
    ...
    async (_, thunkAPI) => {
        const { rejectWithValue } = thunkAPI;
        try {
            const res = await axios.get(baseAPI + '/dashboard/merchant/getblocked/1');
            console.log(res)
            return res.data;
        } catch (error) {
